...
- [src/zerow.langium](src/zerow.langium) -  The grammar definition of your language
- [src/zerow-module.ts](src/zerow-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/zerow-validator.ts](src/zerow-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/zerow.monarch.ts](src/syntaxes/zerow.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/zerow.tmLanguage.json](syntaxes/zerow.tmLanguage.json) - Textmate based syntax highlighting instructions.
